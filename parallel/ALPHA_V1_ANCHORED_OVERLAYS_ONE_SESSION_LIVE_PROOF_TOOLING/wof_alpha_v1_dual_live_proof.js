(async()=>{
'use strict';
const VERSION='wof-alpha-v1-dual-live-proof-loader-recovery-v2';
...
if(isTop){
  await load(BASE+'proof_core.js','dual proof core');
  await load(BASE+'wof_alpha_v1_dual_live_proof_top.js','dual proof Top observer');
  console.log('✅ Alpha V1 dual live-proof loader ready (Top) · '+VERSION);
}else{
  await load(BASE+'wof_alpha_v1_dual_live_proof_worker.js','dual proof Worker observer');
  console.log('✅ Alpha V1 dual live-proof loader ready (Worker) · '+VERSION);
}
