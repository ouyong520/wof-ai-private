...
$RepoBase = 'https://raw.githubusercontent.com/ouyong520/wof-ai-private/main/'
$ManifestUrl = $RepoBase + 'parallel/OWNER_ONECLICK/package_manifest.json'
...
try {
    ...
    if ($manifest.baseUrl -ne $RepoBase) { throw '版本清单下载源不在允许的官方项目路径' }
